...
import { Spinner, Alert, Table, Container, Row, Col, Button, ButtonGroup } from 'react-bootstrap';
...
const Reports = () => {
  ...
  const exportToPDF = () => {
    ...
    autoTable(doc, {
      head: [[
        'Customer ID','Customer Username','Customer Email', 'Total Purchases', 'Total Items', 'Total Paid',
        'Total Due', 'Installment No.', 'Paid Amount', 'Due Amount', 'Status',
      ]],
      body: tableData,
      startY: 20,
    });
